...
app.createPlane = () => {
  ...
  plane.receiveShadow = false;  // shadows are cast onto this
...
app.createCube = ({x, y, z} = {x: -4, y: 15, z: 0}) => {
  ...
  const cubeGeometry = new THREE.BoxGeometry(
    //4, 4, 4
    4, //THREE.Math.randInt(2, 80),
    4, //THREE.Math.randInt(2, 20),
    4
  );
  ...
  // custom variables in userData
  cube.userData.rotationSpeed = Math.random() * 0.01;
