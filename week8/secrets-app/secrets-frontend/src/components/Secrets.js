...
const SECRETS_URL = 'http://localhost:3000/secrets.json'; // 'http://10.1.7.201:3001/secrets.json';
...
class Secrets extends React.Component {
  ...
  // Kind of like jQuery $(document).ready():
  // do something when this component is first
  // added to the page
  // 'Lifecycle method'
  componentDidMount() {
    console.log('mounted!');
    ...
    // This is called 'polling' the server and it's very inefficient (we get the entire list each
    // time, not just the new secrets,
    // and most of the time the list will not have changed)
    window.setInterval( () => this.fetchSecrets(), 5000);
  } // componentDidMount
