...
describe('Express server', () => {
  ...
  // beforeEach() - this callback runs once before _every_ test
  ...
  describe('GET /flights', () => {
    ...
    it('returns a valid JSON object with the correct number of flights', () => {
      ...
      // each test (just like in Rails RSpec) instead of query
      expect( response.data.length ).to.equal( 3 );
    });

    it('returns the correct list of flights', () => {
      expect( response.data[0].flight_number ).to.equal('555');
    });
