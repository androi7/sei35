...
# No we start writing tests using the DSL of RSpec
...
describe Bank do
  ...
  let( :bank ) { Bank.new 'GA Bank' }  # one liner with curly brackets
  ...
  describe '.new' do
    ...
    it 'creates a new Bank object' do
      # bank = Bank.new 'GA Bank'  # Arrane & Act, is now done with let(...)
    ...
    it 'assigns a name to the bank' do
      # bank = Bank.new 'GA Bank'  # Arrange & Act
